...
samarreta tècnica i reutilització de les fotografies actuals; reutilització
de les fotografies de les escoles; i confirmació de les dades de contacte
(correu, telèfons, seu, horari i CIF).
...
| Estatuts (PDF)          | Aprovat  | La persona mantenidora va confirmar el 6 d'agost de 2026 que l'associació ja disposa del PDF dels estatuts. Versionat localment com a `apps/web/src/content-assets/documents/estatuts-mrb.pdf` a la T3.4, amb entrada publicada a la col·lecció `documents`; la pàgina el referència amb validació editorial.                                                                                                |
...
| Fotografies de la secció  | Aprovat   | Es reutilitzaran les fotografies de la pàgina de Socis de la web actual (decisió del 6 d'agost de 2026). Descarregades, optimitzades i versionades localment com a `apps/web/src/assets/members/socis-portada.jpg` i `apps/web/src/assets/members/socis-serveis.jpg` a la T3.5, amb l'atribució de la portada (`@about_paulagnf`) que publica la web actual. |
...
fase. A la T3.5 s'ha modelat cada entitat amb el seu avantatge de soci al YAML
publicat i se n'han descarregat i versionat els logotips localment amb l'URL
d'origen registrat; les dades de contacte personals (telèfons mòbils i correus
d'autònoms) no s'incorporen, d'acord amb la revisió de privacitat de la fase.
...
| Element                      | Estat     | Observació i pendents                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ---------------------------- | --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Correu electrònic            | Aprovat   | `info@mountainrunners.cat`, publicat a la pàgina de contacte i a la política de privadesa, confirmat per a publicació el 6 d'agost de 2026.                                                                                                                                                                                                                                                                                                                                                                                         |
| Telèfons                     | Aprovat   | Telèfon fix 938 213 747 i mòbil 691 910 774, publicats a la pàgina de contacte, confirmats per a publicació el 6 d'agost de 2026.                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| Horari                       | Aprovat   | De dilluns a divendres, de 18 h a 20 h, publicat al peu, confirmat per a publicació el 6 d'agost de 2026.                                                                                                                                                                                                                                                                                                                                                                                                                           |
| CIF                          | Aprovat   | G63999817, publicat al peu i a la política de privadesa, confirmat per a publicació el 6 d'agost de 2026.                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| Estatuts (PDF)                         | <http://mountainrunners.eu/mountainrunners/wp-content/uploads/2021/06/ESTATUTS-MRB.pdf> (ara redirigeix a una pàgina de verificació; el mateix fitxer es serveix al mirall `mountainrunners.cat`) | Aprovat | L'associació ja disposa del PDF; versionat com a `apps/web/src/content-assets/documents/estatuts-mrb.pdf` a la T3.4 i referenciat des de la pàgina Qui som.                                      |
| Fotografies de junta i història        | <https://mountainrunners.cat/el-club/>                                                                                                                                                            | Aprovat | La fotografia de la junta es va versionar com a `apps/web/src/assets/junta-directiva.jpg` a la T3.4; les fotografies històriques queden descartades de moment (vegeu Qui som).                   |
...
| Fotografies de la pàgina de Socis      | <https://mountainrunners.cat/socis/>                                                                                                                                                              | Aprovat | Es reutilitzen les de la web actual (decisió del 6 d'agost de 2026); versionades localment com a `apps/web/src/assets/members/socis-portada.jpg` i `socis-serveis.jpg` a la T3.5, amb atribució. |
| Logotips i imatges dels col·laboradors | Instagram i webs dels establiments, enllaçades des de la pàgina d'avantatges                                                                                                                      | Aprovat | Reutilització aprovada amb el llistat de la web actual; logotips descarregats de la web actual i versionats a `apps/web/src/assets/collaborators/` amb `sourceUrl` registrat (T3.5).             |
