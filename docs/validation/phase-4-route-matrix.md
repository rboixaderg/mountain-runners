...
| Inscripció oberta                     | Llobregat per la Diabetis                                                                                                        | `matrix state`                                                   |
| Inscripció properament                | Cap ruta publicada (`mountain-day` té `published: false`)                                                                        | Proves unitàries de `getRegistrationPresentation`                |
